...
@EnableScheduling
@EnableFeignClients
@org.springframework.boot.autoconfigure.domain.EntityScan(basePackages = {"com.fooddelivery.advertisement.pacing", "com.fooddelivery.common"})
@org.springframework.data.jpa.repository.config.EnableJpaRepositories(basePackages = {"com.fooddelivery.advertisement.pacing", "com.fooddelivery.common"})
